...
import {
  authenticate as templateAuthenticate,
  makeRequest,
...
export async function sendMessage(args: any, context: RLangContext) {
  ...
  Object.keys(rocketChatParams).forEach((key: string) => {
  ...
  try {
    ...
    throw new Error(`RocketChat sendMessage failed: ${getErrorMessage(error)}`);
  }
}
...
export async function getMessages(args: any, context: RLangContext) {
  ...
  try {
    ...
    throw new Error(`RocketChat getMessages failed: ${getErrorMessage(error)}`);
  }
}
...
export async function uploadFile(args: any, context: RLangContext) {
  ...
  try {
    ...
    throw new Error(`RocketChat uploadFile failed: ${getErrorMessage(error)}`);
  }
}
...
export async function createDM(args: any, context: RLangContext) {
  ...
  try {
    ...
    throw new Error(`RocketChat createDM failed: ${getErrorMessage(error)}`);
  }
}
...
export async function getUserInfo(args: any, context: RLangContext) {
  ...
  try {
    ...
    throw new Error(`RocketChat getUserInfo failed: ${getErrorMessage(error)}`);
  }
}
...
export async function reactToMessage(args: any, context: RLangContext) {
  ...
  try {
    ...
    throw new Error(
      `RocketChat reactToMessage failed: ${getErrorMessage(error)}`,
    );
  }
}
...
export async function deleteMessage(args: any, context: RLangContext) {
  ...
  try {
    ...
    throw new Error(
      `RocketChat deleteMessage failed: ${getErrorMessage(error)}`,
    );
  }
}
...
export async function updateMessage(args: any, context: RLangContext) {
  ...
  try {
    ...
    throw new Error(
      `RocketChat updateMessage failed: ${getErrorMessage(error)}`,
    );
  }
}
